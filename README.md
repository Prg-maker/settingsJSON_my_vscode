...
/*
	...
	//  - adamvoss.vscode-languagetool: LanguageTool grammar checking for Visual Studio Code.
	...
	// Allow to enable languageTool on specific workspaces
